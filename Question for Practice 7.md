____###1.What is the purpose of the ? operator in Dart null safety?
? is used to make a variable type nullable, meaning it can contain null.
> String? name; //Can be null or contain a text value.
____###2.Create a late variable named address, assign a US value to it and print it.____________________
>void main() {
  late String address;
  address = "US";
  print(address);
